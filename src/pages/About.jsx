...
const About = () => {
  return (
      ...
      <img src="https://demothemedh.b-cdn.net/piizalian/wp-content/uploads/2021/03/hawaiian-pizza-2.jpg" alt="" />
        </div>
        </div>
      </div>
